...
namespace E_conomic
{
    public class Model
    {
        ...
        public List<dtoGastoComparar> comparartipoGastosMes(int idusuario, int tipo, int mes) 
        {
        ...
        public List<dtoGastoComparar> comparartipoGastosAno(int idusuario, int tipo, int ano)
        {
